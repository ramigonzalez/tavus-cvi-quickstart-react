...
export const WelcomeStep: React.FC<WelcomeStepProps> = ({
  ...
  <div className="min-h-screen flex flex-col items-center justify-center px-4 onboarding-bg">
    ...
    <Card className="w-full max-w-sm mx-auto mt-8">
      ...
      />
      <div className="mb-4">
        <label className="block text-base font-semibold text-[--color-primary-400] mb-1">Preferred Language</label>
        <select
      ...
      <div className="mb-4">
        <label className="block text-base font-semibold text-[--color-primary-400] mb-1">Preferred Voice Gender</label>
        <select
          className="w-full bg-[--color-surface-900] border border-gray-700 rounded-16 px-4 py-3 text-white text-lg focus:outline-none focus:ring-2 focus:ring-[--color-primary-600] focus:border-transparent transition-all duration-200 shadow-sm"
          value={gender}
