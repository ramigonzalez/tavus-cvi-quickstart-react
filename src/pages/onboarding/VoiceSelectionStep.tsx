...
export const VoiceSelectionStep: React.FC<VoiceSelectionStepProps> = ({
  onNext,
  onBack,
  stepIndex,
  totalSteps,
  ...
  <div className="min-h-screen flex flex-col items-center justify-center px-4 onboarding-bg">
    ...
    <Card className="w-full max-w-sm mx-auto mt-8 flex flex-col items-center">
      <h1 className="heading-gradient text-3xl font-bold mb-4">Voice Selection</h1>
      <p className="text-base text-[--color-neutral-0] mb-6 text-center">Choose the voice that resonates with you most.</p>
      <div className="my-6">
